...
To begin this tutorial you will need to have Pandora installed on your computer. Take a look to the Installation (see 02_src/INSTALLING_PANDORA) documentation if you have not make it before. It is strongly recommended to have some background on object oriented programming (preferably using C++).
